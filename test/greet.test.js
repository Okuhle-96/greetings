...
const connectionString = process.env.DATABASE_URL || 'postgresql://localhost:5432/users_test';
...
describe('The basic database web app', function () {
    ...
    it('Should be able to display the names greeted', async function () {
        ...
        assert.deepEqual([{username: 'Kodwa'},
                          {username: 'Matt'},
                          {username: 'Salvatore'}], namesGreeted);
    });
